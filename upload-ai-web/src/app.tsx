        ...
        <main className='flex-1 p-6 flex gap-6'>
          <div className='flex flex-col flex-1 gap-4'>
            ...
            <p className='text-sm text-muted-foreground'>
              Lembre-se: você pode utilizar a varivável <code className='text-red-400'>{'{transcription}'}</code> no seu prompt para adicionar o conteúdo da transição do vídeo selecionado.
            </p>
          </div>
